...
stat_choices <- function(onlyPitchers) {
  if (onlyPitchers == "Yes") {
    return(c("Wins Above Replacement", "Games Played", "At Bats", "Runs Scored", "Hits", "Home Runs", "Runs Batted In", "Stolen Bases", "Bases on Balls", "Batting Average", "On Base Percentage", "On Base and Slugging %", "Total Bases", "Vote PTS", "Wins", "Losses", "ERA", "WHIP", "Games Pitched", "Games Started Pitched", "Saves", "Innings Pitched", "Hits Allowed", "Home Runs Allowed", "Base on Balls Allowed", "Strike Outs"))

  } else {
    return(c("Wins Above Replacement", "Games Played", "At Bats", "Runs Scored", "Hits", "Home Runs", "Runs Batted In", "Stolen Bases", "Bases on Balls", "Batting Average", "On Base Percentage", "On Base and Slugging %", "Total Bases", "Vote PTS"))
  }
}

cy_young_choices <- c("WAR","Wins","Losses","Saves","ERA","Innings Pitched","Strikeouts")
```
...
```{r, echo=FALSE}
inputPanel(
  uiOutput("roy_stat_selector"),
  checkboxInput("ry_nl_league", "National League Teams", value = TRUE),
  checkboxInput("ry_al_league", "American League Teams", value = TRUE),
  checkboxInput("ry_only_pitchers", "Only Pitchers", value = FALSE),
)

output$stat_selector <- renderUI({
  selectInput("Roy_stat", label = "Statistic",
              choices = stat_choices(input$only_pitchers), selected = isolate(input$roy_stat))
})
```
