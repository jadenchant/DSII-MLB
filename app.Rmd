...
stat_choices_roy <- function(only_pitchers) {
  if (only_pitchers) {
    return(c("Wins Above Replacement", "At Bats", "Home Runs", "Runs Batted In", "Stolen Bases", "Batting Average", "On Base Percentage", "Slugging Percentage", 
             "Wins", "Losses", "ERA", "Saves", "Innings Pitched", "Strike Outs"))
  } else {
    return(c("Wins Above Replacement", "At Bats", "Home Runs", "Runs Batted In", "Stolen Bases", "Batting Average", "On Base Percentage", "Slugging Percentage"))
  }
}
...
![MLB Logo](https://ca-times.brightspotcdn.com/dims4/default/615a0d4/2147483647/strip/true/crop/6772x4515+0+0/resize/1200x800!/quality/75/?url=https%3A%2F%2Fcalifornia-times-brightspot.s3.amazonaws.com%2F3e%2Faf%2Fd25941ca43c985a5ea46d3173e2b%2Fhttps-delivery-gettyimages.com%2Fdownloads%2F1958547187)
...
renderPlotly({
  ...
  # |>
    ...
    add_trace(
      ...
      showlegend = FALSE)|>
    layout(
      title = paste("MLB ROY Statistics:", input$mvp_stat),
      xaxis = list(title = "Year"),
      yaxis = list(title = input$mvp_stat),
      showlegend= F,
      shapes= list(
